...
export async function handlerLogin(req: Request, res: Response) {
    ...
    const expiresInSeconds = requestBody.expiresInSeconds ?? 3600; // default 1 hour expiration
    ...
    const jwtToken = makeJWT(queryUser.id, expiresInSeconds, process.env.TOKEN_STRING!);
